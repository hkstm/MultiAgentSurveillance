...
public class WorldMap implements Serializable {
    ...
    public static final int OPEN_WINDOW = 9;
    public static final int MARKER_1 = 10;
    public static final int MARKER_2 = 11;
    public static final int MARKER_3 = 12;
    public static final int MARKER_4 = 13;
    public static final int MARKER_5 = 14;
    public static final int UNEXPLORED = 15;
